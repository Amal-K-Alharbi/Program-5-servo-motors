...
but in a real-world setup, it is strongly recommended to use an external power supply (e.g., 5V / 2A or higher).
This prevents voltage drops or Arduino resets due to high current draw.
Always connect the grounds (GND) of the external power supply and Arduino together.
